...
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_ENABLED;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_HOURS;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_ID;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_MINUTES;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_NAME;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_SOUND;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ALARM_VIBRATE;
import static com.example.deuxalarmes.database.DBConstants.FIELD_ID;
import static com.example.deuxalarmes.database.DBConstants.FIELD_VALUE;
import static com.example.deuxalarmes.database.DBConstants.TABLE_ALARMS;
import static com.example.deuxalarmes.database.DBConstants.TABLE_DAYS;
import static com.example.deuxalarmes.database.DBConstants.TABLE_WEEKS;
import static com.example.deuxalarmes.general.Constants.DAYS_TYPES;
import static com.example.deuxalarmes.general.Constants.INT_NO_VALUE;
import static com.example.deuxalarmes.general.Constants.WEEKS_TYPES;
import static com.example.deuxalarmes.general.GeneralMethods.castToBooleanArray;
